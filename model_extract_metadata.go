...
func (o *ExtractMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varExtractMetadata := _ExtractMetadata{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varExtractMetadata)

	if err != nil {
		return err
	}

	*o = ExtractMetadata(varExtractMetadata)
