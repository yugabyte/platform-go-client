...
// checks if the CustomServerCertData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomServerCertData{}
...
type _CustomServerCertData CustomServerCertData
...
func (o CustomServerCertData) ToMap() (map[string]interface{}, error) {
...
func (o *CustomServerCertData) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomServerCertData := _CustomServerCertData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCustomServerCertData)

	if err != nil {
		return err
	}

	*o = CustomServerCertData(varCustomServerCertData)
