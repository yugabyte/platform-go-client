...
func (o *BootstrapBackupParams) UnmarshalJSON(data []byte) (err error) {
	...
	varBootstrapBackupParams := _BootstrapBackupParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBootstrapBackupParams)

	if err != nil {
		return err
	}

	*o = BootstrapBackupParams(varBootstrapBackupParams)
