...
// checks if the EarlyoomConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EarlyoomConfig{}
...
func (o *EarlyoomConfig) GetAvailMemoryKillKb() int32 {
	if o == nil || IsNil(o.AvailMemoryKillKb) {
		var ret int32
		return ret
	}
...
func (o *EarlyoomConfig) GetAvailMemoryKillPercent() int32 {
	if o == nil || IsNil(o.AvailMemoryKillPercent) {
		var ret int32
		return ret
	}
...
func (o *EarlyoomConfig) GetAvailMemoryTermKb() int32 {
	if o == nil || IsNil(o.AvailMemoryTermKb) {
		var ret int32
		return ret
	}
...
func (o *EarlyoomConfig) GetAvailMemoryTermPercent() int32 {
	if o == nil || IsNil(o.AvailMemoryTermPercent) {
		var ret int32
		return ret
	}
...
func (o *EarlyoomConfig) GetPreferPattern() string {
	if o == nil || IsNil(o.PreferPattern) {
		var ret string
		return ret
	}
