...
func (o *UpdatePitrConfigParams) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdatePitrConfigParams := _UpdatePitrConfigParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdatePitrConfigParams)

	if err != nil {
		return err
	}

	*o = UpdatePitrConfigParams(varUpdatePitrConfigParams)
