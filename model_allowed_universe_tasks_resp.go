...
// checks if the AllowedUniverseTasksResp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllowedUniverseTasksResp{}
...
func (o AllowedUniverseTasksResp) ToMap() (map[string]interface{}, error) {
