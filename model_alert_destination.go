...
func (o *AlertDestination) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertDestination := _AlertDestination{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAlertDestination)

	if err != nil {
		return err
	}

	*o = AlertDestination(varAlertDestination)
