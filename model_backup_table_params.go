...
func (o *BackupTableParams) UnmarshalJSON(data []byte) (err error) {
	...
	varBackupTableParams := _BackupTableParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBackupTableParams)

	if err != nil {
		return err
	}

	*o = BackupTableParams(varBackupTableParams)
