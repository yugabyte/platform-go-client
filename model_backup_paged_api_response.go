...
// checks if the BackupPagedApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BackupPagedApiResponse{}
...
type _BackupPagedApiResponse BackupPagedApiResponse
...
func (o BackupPagedApiResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BackupPagedApiResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBackupPagedApiResponse := _BackupPagedApiResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBackupPagedApiResponse)

	if err != nil {
		return err
	}

	*o = BackupPagedApiResponse(varBackupPagedApiResponse)
