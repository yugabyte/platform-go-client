...
func (o *DrConfigRestartForm) UnmarshalJSON(data []byte) (err error) {
	...
	varDrConfigRestartForm := _DrConfigRestartForm{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDrConfigRestartForm)

	if err != nil {
		return err
	}

	*o = DrConfigRestartForm(varDrConfigRestartForm)
