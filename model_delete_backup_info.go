...
func (o *DeleteBackupInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varDeleteBackupInfo := _DeleteBackupInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDeleteBackupInfo)

	if err != nil {
		return err
	}

	*o = DeleteBackupInfo(varDeleteBackupInfo)
