...
func (o *KeyspaceTablesList) UnmarshalJSON(data []byte) (err error) {
	...
	varKeyspaceTablesList := _KeyspaceTablesList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varKeyspaceTablesList)

	if err != nil {
		return err
	}

	*o = KeyspaceTablesList(varKeyspaceTablesList)
