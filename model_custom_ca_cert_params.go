...
func (o *CustomCACertParams) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomCACertParams := _CustomCACertParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCustomCACertParams)

	if err != nil {
		return err
	}

	*o = CustomCACertParams(varCustomCACertParams)
