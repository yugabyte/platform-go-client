...
func (o *CertificateParams) UnmarshalJSON(data []byte) (err error) {
	...
	varCertificateParams := _CertificateParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCertificateParams)

	if err != nil {
		return err
	}

	*o = CertificateParams(varCertificateParams)
