...
func (o *GroupMappingInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varGroupMappingInfo := _GroupMappingInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGroupMappingInfo)

	if err != nil {
		return err
	}

	*o = GroupMappingInfo(varGroupMappingInfo)
