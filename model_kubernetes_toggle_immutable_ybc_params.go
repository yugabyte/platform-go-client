...
// checks if the KubernetesToggleImmutableYbcParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesToggleImmutableYbcParams{}

// KubernetesToggleImmutableYbcParams struct for KubernetesToggleImmutableYbcParams
type KubernetesToggleImmutableYbcParams struct {
	...
	// Use YBDB image inbuilt YBC
	UseYbdbInbuiltYbc bool `json:"useYbdbInbuiltYbc"`
...
type _KubernetesToggleImmutableYbcParams KubernetesToggleImmutableYbcParams
...
func NewKubernetesToggleImmutableYbcParams(clusters []Cluster, creatingUser Users, kubernetesUpgradeSupported bool, platformUrl string, sleepAfterMasterRestartMillis int32, sleepAfterTServerRestartMillis int32, upgradeOption string, useYbdbInbuiltYbc bool) *KubernetesToggleImmutableYbcParams {
	...
	this.UseYbdbInbuiltYbc = useYbdbInbuiltYbc
	return &this
}
...
// GetUseYbdbInbuiltYbc returns the UseYbdbInbuiltYbc field value
...
// GetUseYbdbInbuiltYbcOk returns a tuple with the UseYbdbInbuiltYbc field value
// and a boolean to check if the value has been set.
...
// SetUseYbdbInbuiltYbc sets field value
...
func (o KubernetesToggleImmutableYbcParams) MarshalJSON() ([]byte, error) {
...
func (o KubernetesToggleImmutableYbcParams) ToMap() (map[string]interface{}, error) {
...
func (o *KubernetesToggleImmutableYbcParams) UnmarshalJSON(data []byte) (err error) {
	...
	varKubernetesToggleImmutableYbcParams := _KubernetesToggleImmutableYbcParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varKubernetesToggleImmutableYbcParams)

	if err != nil {
		return err
	}

	*o = KubernetesToggleImmutableYbcParams(varKubernetesToggleImmutableYbcParams)

	return err
}

type NullableKubernetesToggleImmutableYbcParams struct {
	value *KubernetesToggleImmutableYbcParams
	isSet bool
}

func (v NullableKubernetesToggleImmutableYbcParams) Get() *KubernetesToggleImmutableYbcParams {
	return v.value
}

func (v *NullableKubernetesToggleImmutableYbcParams) Set(val *KubernetesToggleImmutableYbcParams) {
	v.value = val
	v.isSet = true
}

func (v NullableKubernetesToggleImmutableYbcParams) IsSet() bool {
	return v.isSet
}

func (v *NullableKubernetesToggleImmutableYbcParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKubernetesToggleImmutableYbcParams(val *KubernetesToggleImmutableYbcParams) *NullableKubernetesToggleImmutableYbcParams {
	return &NullableKubernetesToggleImmutableYbcParams{value: val, isSet: true}
}

func (v NullableKubernetesToggleImmutableYbcParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKubernetesToggleImmutableYbcParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
