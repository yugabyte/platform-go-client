...
var _ MappedNullable = &LdapUnivSyncFormData{}
...
type _LdapUnivSyncFormData LdapUnivSyncFormData
...
func (o *LdapUnivSyncFormData) GetLdapGroupMemberOfAttribute() string {
	if o == nil || IsNil(o.LdapGroupMemberOfAttribute) {
		var ret string
		return ret
	}
...
func (o *LdapUnivSyncFormData) GetLdapSearchFilter() string {
	if o == nil || IsNil(o.LdapSearchFilter) {
		var ret string
		return ret
	}
...
func (o *LdapUnivSyncFormData) GetLdapTlsProtocol() string {
	if o == nil || IsNil(o.LdapTlsProtocol) {
		var ret string
		return ret
	}
...
func (o LdapUnivSyncFormData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CreateGroups) {
	...
	if !IsNil(o.ExcludeUsers) {
		toSerialize["excludeUsers"] = o.ExcludeUsers
	}
	if !IsNil(o.GroupsToSync) {
	...
	if !IsNil(o.LdapGroupMemberOfAttribute) {
...
func (o *LdapUnivSyncFormData) UnmarshalJSON(data []byte) (err error) {
	...
	varLdapUnivSyncFormData := _LdapUnivSyncFormData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLdapUnivSyncFormData)

	if err != nil {
		return err
	}

	*o = LdapUnivSyncFormData(varLdapUnivSyncFormData)
