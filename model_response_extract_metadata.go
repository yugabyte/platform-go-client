...
var _ MappedNullable = &ResponseExtractMetadata{}
...
func (o ResponseExtractMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseExtractMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseExtractMetadata := _ResponseExtractMetadata{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseExtractMetadata)

	if err != nil {
		return err
	}

	*o = ResponseExtractMetadata(varResponseExtractMetadata)
