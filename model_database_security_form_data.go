...
// checks if the DatabaseSecurityFormData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatabaseSecurityFormData{}
...
func (o *DatabaseSecurityFormData) GetYcqlAdminPassword() string {
	if o == nil || IsNil(o.YcqlAdminPassword) {
		var ret string
		return ret
	}
...
func (o *DatabaseSecurityFormData) GetYcqlAdminUsername() string {
	if o == nil || IsNil(o.YcqlAdminUsername) {
		var ret string
		return ret
	}
...
func (o *DatabaseSecurityFormData) GetYcqlCurrAdminPassword() string {
	if o == nil || IsNil(o.YcqlCurrAdminPassword) {
		var ret string
		return ret
	}
...
func (o *DatabaseSecurityFormData) GetYsqlAdminPassword() string {
	if o == nil || IsNil(o.YsqlAdminPassword) {
		var ret string
		return ret
	}
...
func (o *DatabaseSecurityFormData) GetYsqlAdminUsername() string {
	if o == nil || IsNil(o.YsqlAdminUsername) {
		var ret string
		return ret
	}
...
func (o *DatabaseSecurityFormData) GetYsqlCurrAdminPassword() string {
	if o == nil || IsNil(o.YsqlCurrAdminPassword) {
		var ret string
		return ret
	}
