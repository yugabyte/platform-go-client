...
func (o *BackupRequestParams) UnmarshalJSON(data []byte) (err error) {
	...
	varBackupRequestParams := _BackupRequestParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBackupRequestParams)

	if err != nil {
		return err
	}

	*o = BackupRequestParams(varBackupRequestParams)
