...
func (o *NodeInstanceData) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeInstanceData := _NodeInstanceData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeInstanceData)

	if err != nil {
		return err
	}

	*o = NodeInstanceData(varNodeInstanceData)
