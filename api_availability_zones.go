...
type ApiCreateAZRequest struct {
...
func (r ApiCreateAZRequest) AzFormData(azFormData AvailabilityZoneFormData) ApiCreateAZRequest {
	r.azFormData = &azFormData
	return r
}

func (r ApiCreateAZRequest) Execute() (map[string]AvailabilityZone, *_nethttp.Response, error) {
 ...
 * @param pUUID
 * @param rUUID
 * @return ApiCreateAZRequest
 */
func (a *AvailabilityZonesApiService) CreateAZ(ctx _context.Context, cUUID string, pUUID string, rUUID string) ApiCreateAZRequest {
	return ApiCreateAZRequest{
		ApiService: a,
		ctx: ctx,
		cUUID: cUUID,
 ...
 */
func (a *AvailabilityZonesApiService) CreateAZExecute(r ApiCreateAZRequest) (map[string]AvailabilityZone, *_nethttp.Response, error) {
	var (
...
type ApiDeleteAZRequest struct {
	ctx _context.Context
	ApiService *AvailabilityZonesApiService
	cUUID string
	pUUID string
...
func (r ApiDeleteAZRequest) Execute() (YBPSuccess, *_nethttp.Response, error) {
 ...
 * @param rUUID
 * @param azUUID
 * @return ApiDeleteAZRequest
 */
func (a *AvailabilityZonesApiService) DeleteAZ(ctx _context.Context, cUUID string, pUUID string, rUUID string, azUUID string) ApiDeleteAZRequest {
	return ApiDeleteAZRequest{
		ApiService: a,
		ctx: ctx,
		cUUID: cUUID,
 ...
 * @return YBPSuccess
 */
func (a *AvailabilityZonesApiService) DeleteAZExecute(r ApiDeleteAZRequest) (YBPSuccess, *_nethttp.Response, error) {
	var (
...
type ApiListOfAZRequest struct {
	ctx _context.Context
	ApiService *AvailabilityZonesApiService
	cUUID string
	pUUID string
...
func (r ApiListOfAZRequest) Execute() ([]AvailabilityZone, *_nethttp.Response, error) {
 ...
 * @param pUUID
 * @param rUUID
 * @return ApiListOfAZRequest
 */
func (a *AvailabilityZonesApiService) ListOfAZ(ctx _context.Context, cUUID string, pUUID string, rUUID string) ApiListOfAZRequest {
	return ApiListOfAZRequest{
		ApiService: a,
		ctx: ctx,
		cUUID: cUUID,
 ...
 */
func (a *AvailabilityZonesApiService) ListOfAZExecute(r ApiListOfAZRequest) ([]AvailabilityZone, *_nethttp.Response, error) {
	var (
