...
// checks if the RestartTaskParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestartTaskParams{}
...
type _RestartTaskParams RestartTaskParams
...
func (o RestartTaskParams) MarshalJSON() ([]byte, error) {
...
func (o RestartTaskParams) ToMap() (map[string]interface{}, error) {
...
func (o *RestartTaskParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRestartTaskParams := _RestartTaskParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRestartTaskParams)

	if err != nil {
		return err
	}

	*o = RestartTaskParams(varRestartTaskParams)

	return err
}

type NullableRestartTaskParams struct {
	value *RestartTaskParams
	isSet bool
}

func (v NullableRestartTaskParams) Get() *RestartTaskParams {
	return v.value
}

func (v *NullableRestartTaskParams) Set(val *RestartTaskParams) {
	v.value = val
	v.isSet = true
}

func (v NullableRestartTaskParams) IsSet() bool {
	return v.isSet
}

func (v *NullableRestartTaskParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestartTaskParams(val *RestartTaskParams) *NullableRestartTaskParams {
	return &NullableRestartTaskParams{value: val, isSet: true}
}

func (v NullableRestartTaskParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRestartTaskParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
