...
func (o *UserProfileData) UnmarshalJSON(data []byte) (err error) {
	...
	varUserProfileData := _UserProfileData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserProfileData)

	if err != nil {
		return err
	}

	*o = UserProfileData(varUserProfileData)
