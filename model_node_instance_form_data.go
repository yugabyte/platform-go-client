...
// checks if the NodeInstanceFormData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeInstanceFormData{}
...
type _NodeInstanceFormData NodeInstanceFormData
...
func (o NodeInstanceFormData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["nodes"] = o.Nodes
	return toSerialize, nil
}

func (o *NodeInstanceFormData) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeInstanceFormData := _NodeInstanceFormData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeInstanceFormData)

	if err != nil {
		return err
	}

	*o = NodeInstanceFormData(varNodeInstanceFormData)
