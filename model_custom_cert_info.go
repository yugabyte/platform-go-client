...
// checks if the CustomCertInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomCertInfo{}
...
type _CustomCertInfo CustomCertInfo
...
func (o CustomCertInfo) ToMap() (map[string]interface{}, error) {
...
func (o *CustomCertInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomCertInfo := _CustomCertInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCustomCertInfo)

	if err != nil {
		return err
	}

	*o = CustomCertInfo(varCustomCertInfo)
