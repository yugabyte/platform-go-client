...
var _ MappedNullable = &AlertPagedApiQuery{}
...
func (o AlertPagedApiQuery) ToMap() (map[string]interface{}, error) {
...
func (o *AlertPagedApiQuery) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertPagedApiQuery := _AlertPagedApiQuery{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAlertPagedApiQuery)

	if err != nil {
		return err
	}

	*o = AlertPagedApiQuery(varAlertPagedApiQuery)
