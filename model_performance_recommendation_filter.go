...
func (o *PerformanceRecommendationFilter) UnmarshalJSON(data []byte) (err error) {
	...
	varPerformanceRecommendationFilter := _PerformanceRecommendationFilter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPerformanceRecommendationFilter)

	if err != nil {
		return err
	}

	*o = PerformanceRecommendationFilter(varPerformanceRecommendationFilter)
