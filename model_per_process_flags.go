...
func (o *PerProcessFlags) UnmarshalJSON(data []byte) (err error) {
	...
	varPerProcessFlags := _PerProcessFlags{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPerProcessFlags)

	if err != nil {
		return err
	}

	*o = PerProcessFlags(varPerProcessFlags)
