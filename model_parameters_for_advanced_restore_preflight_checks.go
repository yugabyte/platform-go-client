...
func (o *ParametersForAdvancedRestorePreflightChecks) UnmarshalJSON(data []byte) (err error) {
	...
	varParametersForAdvancedRestorePreflightChecks := _ParametersForAdvancedRestorePreflightChecks{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varParametersForAdvancedRestorePreflightChecks)

	if err != nil {
		return err
	}

	*o = ParametersForAdvancedRestorePreflightChecks(varParametersForAdvancedRestorePreflightChecks)
