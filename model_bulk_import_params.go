...
func (o *BulkImportParams) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkImportParams := _BulkImportParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBulkImportParams)

	if err != nil {
		return err
	}

	*o = BulkImportParams(varBulkImportParams)
