...
func (o *TaskPagedApiQuery) UnmarshalJSON(data []byte) (err error) {
	...
	varTaskPagedApiQuery := _TaskPagedApiQuery{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTaskPagedApiQuery)

	if err != nil {
		return err
	}

	*o = TaskPagedApiQuery(varTaskPagedApiQuery)
