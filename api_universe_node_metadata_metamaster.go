...
type UniverseNodeMetadataMetamasterApiApiGetMasterLBStateRequest struct {
	ctx _context.Context
	ApiService *UniverseNodeMetadataMetamasterApiService
	cUUID string
	uniUUID string
...
func (r UniverseNodeMetadataMetamasterApiApiGetMasterLBStateRequest) Execute() (MasterLBStateResponse, *_nethttp.Response, error) {
 ...
 * @param cUUID
 * @param uniUUID
 * @return UniverseNodeMetadataMetamasterApiApiGetMasterLBStateRequest
 */
func (a *UniverseNodeMetadataMetamasterApiService) GetMasterLBState(ctx _context.Context, cUUID string, uniUUID string) UniverseNodeMetadataMetamasterApiApiGetMasterLBStateRequest {
	return UniverseNodeMetadataMetamasterApiApiGetMasterLBStateRequest{
		ApiService: a,
		ctx: ctx,
		cUUID: cUUID,
 ...
 */
func (a *UniverseNodeMetadataMetamasterApiService) GetMasterLBStateExecute(r UniverseNodeMetadataMetamasterApiApiGetMasterLBStateRequest) (MasterLBStateResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
