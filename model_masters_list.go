...
// checks if the MastersList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MastersList{}
...
func (o MastersList) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["masters"] = o.Masters
	return toSerialize, nil
}

func (o *MastersList) UnmarshalJSON(data []byte) (err error) {
	...
	varMastersList := _MastersList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMastersList)

	if err != nil {
		return err
	}

	*o = MastersList(varMastersList)
