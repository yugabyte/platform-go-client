...
// checks if the TableDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TableDetails{}
...
func (o TableDetails) ToMap() (map[string]interface{}, error) {
