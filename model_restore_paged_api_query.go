...
func (o *RestorePagedApiQuery) UnmarshalJSON(data []byte) (err error) {
	...
	varRestorePagedApiQuery := _RestorePagedApiQuery{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRestorePagedApiQuery)

	if err != nil {
		return err
	}

	*o = RestorePagedApiQuery(varRestorePagedApiQuery)
