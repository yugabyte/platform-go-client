...
func (o *PerformanceRecommendationPagedResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPerformanceRecommendationPagedResponse := _PerformanceRecommendationPagedResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPerformanceRecommendationPagedResponse)

	if err != nil {
		return err
	}

	*o = PerformanceRecommendationPagedResponse(varPerformanceRecommendationPagedResponse)
