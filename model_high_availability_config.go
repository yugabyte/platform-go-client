...
func (o *HighAvailabilityConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varHighAvailabilityConfig := _HighAvailabilityConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHighAvailabilityConfig)

	if err != nil {
		return err
	}

	*o = HighAvailabilityConfig(varHighAvailabilityConfig)
