...
func (o *CustomerConfigUI) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomerConfigUI := _CustomerConfigUI{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCustomerConfigUI)

	if err != nil {
		return err
	}

	*o = CustomerConfigUI(varCustomerConfigUI)
