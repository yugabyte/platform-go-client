...
// checks if the RestorePagedApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestorePagedApiResponse{}
...
type _RestorePagedApiResponse RestorePagedApiResponse
...
func (o RestorePagedApiResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RestorePagedApiResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRestorePagedApiResponse := _RestorePagedApiResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRestorePagedApiResponse)

	if err != nil {
		return err
	}

	*o = RestorePagedApiResponse(varRestorePagedApiResponse)
