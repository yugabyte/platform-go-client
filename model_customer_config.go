...
func (o *CustomerConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomerConfig := _CustomerConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCustomerConfig)

	if err != nil {
		return err
	}

	*o = CustomerConfig(varCustomerConfig)
