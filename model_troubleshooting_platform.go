...
// checks if the TroubleshootingPlatform type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TroubleshootingPlatform{}
...
type _TroubleshootingPlatform TroubleshootingPlatform
...
func (o TroubleshootingPlatform) ToMap() (map[string]interface{}, error) {
...
func (o *TroubleshootingPlatform) UnmarshalJSON(data []byte) (err error) {
	...
	varTroubleshootingPlatform := _TroubleshootingPlatform{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTroubleshootingPlatform)

	if err != nil {
		return err
	}

	*o = TroubleshootingPlatform(varTroubleshootingPlatform)
