...
// checks if the AlertDestinationFormData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertDestinationFormData{}
...
type _AlertDestinationFormData AlertDestinationFormData
...
func (o AlertDestinationFormData) ToMap() (map[string]interface{}, error) {
...
func (o *AlertDestinationFormData) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertDestinationFormData := _AlertDestinationFormData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAlertDestinationFormData)

	if err != nil {
		return err
	}

	*o = AlertDestinationFormData(varAlertDestinationFormData)
