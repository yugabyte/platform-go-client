...
// checks if the SchedulePagedResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SchedulePagedResponse{}
...
type _SchedulePagedResponse SchedulePagedResponse
...
func (o SchedulePagedResponse) ToMap() (map[string]interface{}, error) {
...
func (o *SchedulePagedResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSchedulePagedResponse := _SchedulePagedResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSchedulePagedResponse)

	if err != nil {
		return err
	}

	*o = SchedulePagedResponse(varSchedulePagedResponse)
