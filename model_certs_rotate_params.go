...
func (o *CertsRotateParams) UnmarshalJSON(data []byte) (err error) {
	...
	varCertsRotateParams := _CertsRotateParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCertsRotateParams)

	if err != nil {
		return err
	}

	*o = CertsRotateParams(varCertsRotateParams)
