...
// checks if the YBPSuccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &YBPSuccess{}
...
func (o YBPSuccess) ToMap() (map[string]interface{}, error) {
