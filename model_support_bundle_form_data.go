...
func (o *SupportBundleFormData) UnmarshalJSON(data []byte) (err error) {
	...
	varSupportBundleFormData := _SupportBundleFormData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSupportBundleFormData)

	if err != nil {
		return err
	}

	*o = SupportBundleFormData(varSupportBundleFormData)
