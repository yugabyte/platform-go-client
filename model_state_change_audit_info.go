...
var _ MappedNullable = &StateChangeAuditInfo{}
...
func (o StateChangeAuditInfo) ToMap() (map[string]interface{}, error) {
...
func (o *StateChangeAuditInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varStateChangeAuditInfo := _StateChangeAuditInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varStateChangeAuditInfo)

	if err != nil {
		return err
	}

	*o = StateChangeAuditInfo(varStateChangeAuditInfo)
