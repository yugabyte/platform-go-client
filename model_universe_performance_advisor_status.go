...
func (o *UniversePerformanceAdvisorStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varUniversePerformanceAdvisorStatus := _UniversePerformanceAdvisorStatus{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUniversePerformanceAdvisorStatus)

	if err != nil {
		return err
	}

	*o = UniversePerformanceAdvisorStatus(varUniversePerformanceAdvisorStatus)
