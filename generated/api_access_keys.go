...
func (r ApiCreateAccesskeyRequest) Execute() (AccessKey, *_nethttp.Response, error) {
 ...
 */
func (a *AccessKeysApiService) CreateAccesskey(ctx _context.Context, cUUID string, pUUID string) ApiCreateAccesskeyRequest {
	return ApiCreateAccesskeyRequest{
		ApiService: a,
		ctx: ctx,
		cUUID: cUUID,
 ...
 * @return AccessKey
 */
func (a *AccessKeysApiService) CreateAccesskeyExecute(r ApiCreateAccesskeyRequest) (AccessKey, *_nethttp.Response, error) {
	var (
...
func (r ApiDeleteAccesskeyRequest) Execute() (YBPSuccess, *_nethttp.Response, error) {
 ...
 */
func (a *AccessKeysApiService) DeleteAccesskey(ctx _context.Context, cUUID string, pUUID string, keyCode string) ApiDeleteAccesskeyRequest {
	return ApiDeleteAccesskeyRequest{
		ApiService: a,
		ctx: ctx,
		cUUID: cUUID,
 ...
 * @return YBPSuccess
 */
func (a *AccessKeysApiService) DeleteAccesskeyExecute(r ApiDeleteAccesskeyRequest) (YBPSuccess, *_nethttp.Response, error) {
	var (
...
func (r ApiIndexRequest) Execute() (AccessKey, *_nethttp.Response, error) {
 ...
 */
func (a *AccessKeysApiService) Index(ctx _context.Context, cUUID string, pUUID string, keyCode string) ApiIndexRequest {
	return ApiIndexRequest{
		ApiService: a,
		ctx: ctx,
		cUUID: cUUID,
 ...
 * @return AccessKey
 */
func (a *AccessKeysApiService) IndexExecute(r ApiIndexRequest) (AccessKey, *_nethttp.Response, error) {
	var (
...
func (r ApiListRequest) Execute() ([]AccessKey, *_nethttp.Response, error) {
 ...
 */
func (a *AccessKeysApiService) List(ctx _context.Context, cUUID string, pUUID string) ApiListRequest {
	return ApiListRequest{
		ApiService: a,
		ctx: ctx,
		cUUID: cUUID,
 ...
 * @return []AccessKey
 */
func (a *AccessKeysApiService) ListExecute(r ApiListRequest) ([]AccessKey, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
