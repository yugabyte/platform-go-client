...
var _ MappedNullable = &RunQueryFormData{}
...
type _RunQueryFormData RunQueryFormData
...
func (o RunQueryFormData) ToMap() (map[string]interface{}, error) {
...
func (o *RunQueryFormData) UnmarshalJSON(data []byte) (err error) {
	...
	varRunQueryFormData := _RunQueryFormData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRunQueryFormData)

	if err != nil {
		return err
	}

	*o = RunQueryFormData(varRunQueryFormData)
