...
func (o *ResizeNodeParams) UnmarshalJSON(data []byte) (err error) {
	...
	varResizeNodeParams := _ResizeNodeParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResizeNodeParams)

	if err != nil {
		return err
	}

	*o = ResizeNodeParams(varResizeNodeParams)
