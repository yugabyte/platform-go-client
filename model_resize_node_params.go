...
// checks if the ResizeNodeParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResizeNodeParams{}
...
type _ResizeNodeParams ResizeNodeParams
...
func (o ResizeNodeParams) ToMap() (map[string]interface{}, error) {
