...
func (o *MetricSettings) UnmarshalJSON(data []byte) (err error) {
	...
	varMetricSettings := _MetricSettings{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMetricSettings)

	if err != nil {
		return err
	}

	*o = MetricSettings(varMetricSettings)
