...
func (o *ResponseRelease) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseRelease := _ResponseRelease{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseRelease)

	if err != nil {
		return err
	}

	*o = ResponseRelease(varResponseRelease)
