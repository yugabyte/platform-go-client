...
func (o *TaskPagedApiResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varTaskPagedApiResponse := _TaskPagedApiResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTaskPagedApiResponse)

	if err != nil {
		return err
	}

	*o = TaskPagedApiResponse(varTaskPagedApiResponse)
