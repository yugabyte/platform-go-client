...
func (o *XClusterConfigCreateFormData) UnmarshalJSON(data []byte) (err error) {
	...
	varXClusterConfigCreateFormData := _XClusterConfigCreateFormData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varXClusterConfigCreateFormData)

	if err != nil {
		return err
	}

	*o = XClusterConfigCreateFormData(varXClusterConfigCreateFormData)
