...
var _ MappedNullable = &ScheduleApiFilter{}
...
type _ScheduleApiFilter ScheduleApiFilter
...
func (o ScheduleApiFilter) ToMap() (map[string]interface{}, error) {
...
func (o *ScheduleApiFilter) UnmarshalJSON(data []byte) (err error) {
	...
	varScheduleApiFilter := _ScheduleApiFilter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScheduleApiFilter)

	if err != nil {
		return err
	}

	*o = ScheduleApiFilter(varScheduleApiFilter)
