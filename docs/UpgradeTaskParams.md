...
`func (o *UpgradeTaskParams) GetPaCollectorUuid() string`

GetPaCollectorUuid returns the PaCollectorUuid field if non-nil, zero value otherwise.

### GetPaCollectorUuidOk

`func (o *UpgradeTaskParams) GetPaCollectorUuidOk() (*string, bool)`
...
`func (o *UpgradeTaskParams) SetPaCollectorUuid(v string)`

SetPaCollectorUuid sets PaCollectorUuid field to given value.

### HasPaCollectorUuid

`func (o *UpgradeTaskParams) HasPaCollectorUuid() bool`
