...
`func NewRestartTaskParams(clusters []Cluster, creatingUser Users, kubernetesUpgradeSupported bool, platformUrl string, rawClientRootCA string, sleepAfterMasterRestartMillis int32, sleepAfterTServerRestartMillis int32, upgradeOption string, ) *RestartTaskParams`
...
`func (o *RestartTaskParams) GetAdditionalServicesStateData() AdditionalServicesStateData`
...
`func (o *RestartTaskParams) GetAdditionalServicesStateDataOk() (*AdditionalServicesStateData, bool)`
...
`func (o *RestartTaskParams) SetAdditionalServicesStateData(v AdditionalServicesStateData)`

SetAdditionalServicesStateData sets AdditionalServicesStateData field to given value.

### HasAdditionalServicesStateData

`func (o *RestartTaskParams) HasAdditionalServicesStateData() bool`
...
`func (o *RestartTaskParams) GetAutoRollbackPerformed() bool`
...
`func (o *RestartTaskParams) GetAutoRollbackPerformedOk() (*bool, bool)`
...
`func (o *RestartTaskParams) SetAutoRollbackPerformed(v bool)`

SetAutoRollbackPerformed sets AutoRollbackPerformed field to given value.

### HasAutoRollbackPerformed

`func (o *RestartTaskParams) HasAutoRollbackPerformed() bool`
...
`func (o *RestartTaskParams) GetFipsEnabled() bool`

GetFipsEnabled returns the FipsEnabled field if non-nil, zero value otherwise.

### GetFipsEnabledOk

`func (o *RestartTaskParams) GetFipsEnabledOk() (*bool, bool)`
...
`func (o *RestartTaskParams) SetFipsEnabled(v bool)`

SetFipsEnabled sets FipsEnabled field to given value.

### HasFipsEnabled

`func (o *RestartTaskParams) HasFipsEnabled() bool`
...
`func (o *RestartTaskParams) SetNodeAgentMissing(v bool)`

SetNodeAgentMissing sets NodeAgentMissing field to given value.

### HasNodeAgentMissing

`func (o *RestartTaskParams) HasNodeAgentMissing() bool`
...
`func (o *RestartTaskParams) GetRawClientRootCA() string`

GetRawClientRootCA returns the RawClientRootCA field if non-nil, zero value otherwise.

### GetRawClientRootCAOk

`func (o *RestartTaskParams) GetRawClientRootCAOk() (*string, bool)`
...
`func (o *RestartTaskParams) SetRawClientRootCA(v string)`
...
`func (o *RestartTaskParams) SetUniverseDetached(v bool)`

SetUniverseDetached sets UniverseDetached field to given value.

### HasUniverseDetached

`func (o *RestartTaskParams) HasUniverseDetached() bool`
