...
`func (o *ThirdpartySoftwareUpgradeParams) GetPaCollectorUuid() string`

GetPaCollectorUuid returns the PaCollectorUuid field if non-nil, zero value otherwise.

### GetPaCollectorUuidOk

`func (o *ThirdpartySoftwareUpgradeParams) GetPaCollectorUuidOk() (*string, bool)`
...
`func (o *ThirdpartySoftwareUpgradeParams) SetPaCollectorUuid(v string)`
