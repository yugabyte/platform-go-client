...
`func (o *CertsRotateParams) GetPaCollectorUuid() string`

GetPaCollectorUuid returns the PaCollectorUuid field if non-nil, zero value otherwise.

### GetPaCollectorUuidOk

`func (o *CertsRotateParams) GetPaCollectorUuidOk() (*string, bool)`
...
`func (o *CertsRotateParams) SetPaCollectorUuid(v string)`

SetPaCollectorUuid sets PaCollectorUuid field to given value.

### HasPaCollectorUuid

`func (o *CertsRotateParams) HasPaCollectorUuid() bool`
