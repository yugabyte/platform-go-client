...
`func NewFinalizeUpgradeParams(clusters []Cluster, creatingUser Users, kubernetesUpgradeSupported bool, platformUrl string, rawClientRootCA string, sleepAfterMasterRestartMillis int32, sleepAfterTServerRestartMillis int32, upgradeOption string, upgradeSystemCatalog bool, ) *FinalizeUpgradeParams`
...
`func (o *FinalizeUpgradeParams) GetRawClientRootCA() string`

GetRawClientRootCA returns the RawClientRootCA field if non-nil, zero value otherwise.

### GetRawClientRootCAOk

`func (o *FinalizeUpgradeParams) GetRawClientRootCAOk() (*string, bool)`
...
`func (o *FinalizeUpgradeParams) SetRawClientRootCA(v string)`
