...
**AirGapInstall** | Pointer to **bool** | Deprecated since YBA version 2.17.2.0, Use details.airGapInstall. Only supported in Create Request | [optional] 
**AllAccessKeys** | Pointer to [**[]AccessKey**](AccessKey.md) |  | [optional] 
**Code** | Pointer to **string** | Provider cloud code | [optional] 
**Config** | Pointer to **map[string]string** | Deprecated since YBA version 2.17.2.0. Use details.metadata instead | [optional] 
**CustomerUUID** | Pointer to **string** | Customer uuid | [optional] [readonly] 
**DestVpcId** | Pointer to **string** | Deprecated since YBA version 2.17.2.0 | [optional] 
**Details** | Pointer to [**ProviderDetails**](ProviderDetails.md) |  | [optional] 
**HostVpcId** | Pointer to **string** | Deprecated since YBA version 2.17.2.0 | [optional] 
**HostVpcRegion** | Pointer to **string** | Deprecated since YBA version 2.17.2.0 | [optional] 
**ImageBundles** | [**[]ImageBundle**](ImageBundle.md) |  | 
**KeyPairName** | Pointer to **string** | Deprecated since YBA version 2.17.2.0, Use allAccessKeys[0].keyInfo.keyPairName instead | [optional] 
**Name** | Pointer to **string** | Provider name | [optional] 
**Regions** | [**[]Region**](Region.md) |  | 
**SshPort** | Pointer to **int32** | Deprecated since YBA version 2.17.2.0, Use details.SshPort instead. Only supported in create request | [optional] 
**SshPrivateKeyContent** | Pointer to **string** | Deprecated since YBA version 2.17.2.0, Use allAccessKeys[0].keyInfo.sshPrivateKeyContent instead | [optional] 
**SshUser** | Pointer to **string** | Deprecated since YBA version 2.17.2.0, Use details.SshUser instead. Only supported in create request | [optional] 
