...
`func (o *KubernetesToggleImmutableYbcParams) GetPaCollectorUuid() string`

GetPaCollectorUuid returns the PaCollectorUuid field if non-nil, zero value otherwise.

### GetPaCollectorUuidOk

`func (o *KubernetesToggleImmutableYbcParams) GetPaCollectorUuidOk() (*string, bool)`
...
`func (o *KubernetesToggleImmutableYbcParams) SetPaCollectorUuid(v string)`

SetPaCollectorUuid sets PaCollectorUuid field to given value.

### HasPaCollectorUuid

`func (o *KubernetesToggleImmutableYbcParams) HasPaCollectorUuid() bool`
