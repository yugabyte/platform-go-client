...
func (o *MaintenanceWindowPagedResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varMaintenanceWindowPagedResponse := _MaintenanceWindowPagedResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMaintenanceWindowPagedResponse)

	if err != nil {
		return err
	}

	*o = MaintenanceWindowPagedResponse(varMaintenanceWindowPagedResponse)
