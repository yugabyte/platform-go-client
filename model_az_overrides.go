...
// checks if the AZOverrides type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AZOverrides{}
...
func (o AZOverrides) ToMap() (map[string]interface{}, error) {
