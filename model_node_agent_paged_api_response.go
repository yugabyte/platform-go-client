...
// checks if the NodeAgentPagedApiResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeAgentPagedApiResponse{}
...
type _NodeAgentPagedApiResponse NodeAgentPagedApiResponse
...
func (o NodeAgentPagedApiResponse) ToMap() (map[string]interface{}, error) {
...
func (o *NodeAgentPagedApiResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeAgentPagedApiResponse := _NodeAgentPagedApiResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeAgentPagedApiResponse)

	if err != nil {
		return err
	}

	*o = NodeAgentPagedApiResponse(varNodeAgentPagedApiResponse)
