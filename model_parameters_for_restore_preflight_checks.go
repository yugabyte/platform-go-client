...
func (o *ParametersForRestorePreflightChecks) UnmarshalJSON(data []byte) (err error) {
	...
	varParametersForRestorePreflightChecks := _ParametersForRestorePreflightChecks{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varParametersForRestorePreflightChecks)

	if err != nil {
		return err
	}

	*o = ParametersForRestorePreflightChecks(varParametersForRestorePreflightChecks)
