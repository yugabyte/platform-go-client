...
func (o *UpgradeTaskParams) UnmarshalJSON(data []byte) (err error) {
	...
	varUpgradeTaskParams := _UpgradeTaskParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpgradeTaskParams)

	if err != nil {
		return err
	}

	*o = UpgradeTaskParams(varUpgradeTaskParams)
