...
// checks if the UpgradeTaskParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpgradeTaskParams{}
...
type _UpgradeTaskParams UpgradeTaskParams
...
func (o UpgradeTaskParams) ToMap() (map[string]interface{}, error) {
