...
func (o *XClusterConfigGetResp) UnmarshalJSON(data []byte) (err error) {
	...
	varXClusterConfigGetResp := _XClusterConfigGetResp{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varXClusterConfigGetResp)

	if err != nil {
		return err
	}

	*o = XClusterConfigGetResp(varXClusterConfigGetResp)
