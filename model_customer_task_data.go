...
// checks if the CustomerTaskData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomerTaskData{}
...
func (o CustomerTaskData) ToMap() (map[string]interface{}, error) {
