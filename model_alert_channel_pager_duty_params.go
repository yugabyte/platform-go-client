...
func (o *AlertChannelPagerDutyParams) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertChannelPagerDutyParams := _AlertChannelPagerDutyParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAlertChannelPagerDutyParams)

	if err != nil {
		return err
	}

	*o = AlertChannelPagerDutyParams(varAlertChannelPagerDutyParams)
