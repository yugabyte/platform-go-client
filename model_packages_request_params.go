...
var _ MappedNullable = &PackagesRequestParams{}
...
type _PackagesRequestParams PackagesRequestParams
...
func (o PackagesRequestParams) ToMap() (map[string]interface{}, error) {
...
func (o *PackagesRequestParams) UnmarshalJSON(data []byte) (err error) {
	...
	varPackagesRequestParams := _PackagesRequestParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPackagesRequestParams)

	if err != nil {
		return err
	}

	*o = PackagesRequestParams(varPackagesRequestParams)
