...
// checks if the AlertChannelSlackParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertChannelSlackParams{}
...
type _AlertChannelSlackParams AlertChannelSlackParams
...
func (o AlertChannelSlackParams) ToMap() (map[string]interface{}, error) {
...
func (o *AlertChannelSlackParams) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertChannelSlackParams := _AlertChannelSlackParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAlertChannelSlackParams)

	if err != nil {
		return err
	}

	*o = AlertChannelSlackParams(varAlertChannelSlackParams)
