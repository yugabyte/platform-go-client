...
var _ MappedNullable = &ImportUniverseFormData{}
...
func (o ImportUniverseFormData) ToMap() (map[string]interface{}, error) {
...
func (o *ImportUniverseFormData) UnmarshalJSON(data []byte) (err error) {
	...
	varImportUniverseFormData := _ImportUniverseFormData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varImportUniverseFormData)

	if err != nil {
		return err
	}

	*o = ImportUniverseFormData(varImportUniverseFormData)
