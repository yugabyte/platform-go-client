...
var _ MappedNullable = &VMImageUpgradeParams{}
...
func (o *VMImageUpgradeParams) GetForceVMImageUpgrade() bool {
	...
	return o.ForceVMImageUpgrade
}

// GetForceVMImageUpgradeOk returns a tuple with the ForceVMImageUpgrade field value
// and a boolean to check if the value has been set.
func (o *VMImageUpgradeParams) GetForceVMImageUpgradeOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ForceVMImageUpgrade, true
}

// SetForceVMImageUpgrade sets field value
...
func (o *VMImageUpgradeParams) GetSshUserOverrideMap() map[string]string {
	if o == nil || IsNil(o.SshUserOverrideMap) {
		var ret map[string]string
		return ret
	}
...
func (o VMImageUpgradeParams) ToMap() (map[string]interface{}, error) {
...
func (v NullableVMImageUpgradeParams) Get() *VMImageUpgradeParams {
	return v.value
}

func (v *NullableVMImageUpgradeParams) Set(val *VMImageUpgradeParams) {
	v.value = val
	v.isSet = true
}

func (v NullableVMImageUpgradeParams) IsSet() bool {
	return v.isSet
}

func (v *NullableVMImageUpgradeParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVMImageUpgradeParams(val *VMImageUpgradeParams) *NullableVMImageUpgradeParams {
	return &NullableVMImageUpgradeParams{value: val, isSet: true}
}

func (v NullableVMImageUpgradeParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVMImageUpgradeParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
