...
func (o *NodeQueryDistributionDetails) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeQueryDistributionDetails := _NodeQueryDistributionDetails{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeQueryDistributionDetails)

	if err != nil {
		return err
	}

	*o = NodeQueryDistributionDetails(varNodeQueryDistributionDetails)
