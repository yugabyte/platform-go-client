...
func (r ApiCreateRequest) CreateMaintenanceWindowRequest(createMaintenanceWindowRequest MaintenanceWindow) ApiCreateRequest {
	r.createMaintenanceWindowRequest = &createMaintenanceWindowRequest
	return r
}

func (r ApiCreateRequest) Execute() (MaintenanceWindow, *_nethttp.Response, error) {
 ...
 */
func (a *MaintenanceWindowsApiService) Create(ctx _context.Context, cUUID string) ApiCreateRequest {
	return ApiCreateRequest{
		ApiService: a,
		ctx: ctx,
		cUUID: cUUID,
 ...
 */
func (a *MaintenanceWindowsApiService) CreateExecute(r ApiCreateRequest) (MaintenanceWindow, *_nethttp.Response, error) {
	var (
...
func (r ApiDeleteRequest) Execute() (YBPSuccess, *_nethttp.Response, error) {
 ...
 */
func (a *MaintenanceWindowsApiService) Delete(ctx _context.Context, cUUID string, windowUUID string) ApiDeleteRequest {
	return ApiDeleteRequest{
		ApiService: a,
		ctx: ctx,
		cUUID: cUUID,
 ...
 * @return YBPSuccess
 */
func (a *MaintenanceWindowsApiService) DeleteExecute(r ApiDeleteRequest) (YBPSuccess, *_nethttp.Response, error) {
	var (
...
func (r ApiGetRequest) Execute() (MaintenanceWindow, *_nethttp.Response, error) {
 ...
 */
func (a *MaintenanceWindowsApiService) Get(ctx _context.Context, cUUID string, windowUUID string) ApiGetRequest {
	return ApiGetRequest{
		ApiService: a,
		ctx: ctx,
		cUUID: cUUID,
 ...
 * @return MaintenanceWindow
 */
func (a *MaintenanceWindowsApiService) GetExecute(r ApiGetRequest) (MaintenanceWindow, *_nethttp.Response, error) {
	var (
...
type ApiListOfMaintenanceWindowsRequest struct {
	ctx _context.Context
	ApiService *MaintenanceWindowsApiService
	cUUID string
}
...
func (r ApiListOfMaintenanceWindowsRequest) Execute() ([]MaintenanceWindow, *_nethttp.Response, error) {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param cUUID
 * @return ApiListOfMaintenanceWindowsRequest
 */
func (a *MaintenanceWindowsApiService) ListOfMaintenanceWindows(ctx _context.Context, cUUID string) ApiListOfMaintenanceWindowsRequest {
	return ApiListOfMaintenanceWindowsRequest{
		ApiService: a,
		ctx: ctx,
		cUUID: cUUID,
 ...
 * @return []MaintenanceWindow
 */
func (a *MaintenanceWindowsApiService) ListOfMaintenanceWindowsExecute(r ApiListOfMaintenanceWindowsRequest) ([]MaintenanceWindow, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiPageRequest) PageMaintenanceWindowsRequest(pageMaintenanceWindowsRequest MaintenanceWindowPagedApiQuery) ApiPageRequest {
	r.pageMaintenanceWindowsRequest = &pageMaintenanceWindowsRequest
	return r
}

func (r ApiPageRequest) Execute() (MaintenanceWindowPagedResponse, *_nethttp.Response, error) {
 ...
 */
func (a *MaintenanceWindowsApiService) Page(ctx _context.Context, cUUID string) ApiPageRequest {
	return ApiPageRequest{
		ApiService: a,
		ctx: ctx,
		cUUID: cUUID,
 ...
 */
func (a *MaintenanceWindowsApiService) PageExecute(r ApiPageRequest) (MaintenanceWindowPagedResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiUpdateRequest) UpdateMaintenanceWindowRequest(updateMaintenanceWindowRequest MaintenanceWindow) ApiUpdateRequest {
	r.updateMaintenanceWindowRequest = &updateMaintenanceWindowRequest
	return r
}

func (r ApiUpdateRequest) Execute() (MaintenanceWindow, *_nethttp.Response, error) {
 ...
 */
func (a *MaintenanceWindowsApiService) Update(ctx _context.Context, cUUID string, windowUUID string) ApiUpdateRequest {
	return ApiUpdateRequest{
		ApiService: a,
		ctx: ctx,
		cUUID: cUUID,
 ...
 * @return MaintenanceWindow
 */
func (a *MaintenanceWindowsApiService) UpdateExecute(r ApiUpdateRequest) (MaintenanceWindow, *_nethttp.Response, error) {
	var (
