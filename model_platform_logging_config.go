...
var _ MappedNullable = &PlatformLoggingConfig{}
...
func (o PlatformLoggingConfig) ToMap() (map[string]interface{}, error) {
...
func (o *PlatformLoggingConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varPlatformLoggingConfig := _PlatformLoggingConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPlatformLoggingConfig)

	if err != nil {
		return err
	}

	*o = PlatformLoggingConfig(varPlatformLoggingConfig)
