...
func (o *CreatePitrConfigParams) UnmarshalJSON(data []byte) (err error) {
	...
	varCreatePitrConfigParams := _CreatePitrConfigParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreatePitrConfigParams)

	if err != nil {
		return err
	}

	*o = CreatePitrConfigParams(varCreatePitrConfigParams)
