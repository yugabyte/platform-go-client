...
func (o *PerformanceRecommendationPagedQuery) UnmarshalJSON(data []byte) (err error) {
	...
	varPerformanceRecommendationPagedQuery := _PerformanceRecommendationPagedQuery{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPerformanceRecommendationPagedQuery)

	if err != nil {
		return err
	}

	*o = PerformanceRecommendationPagedQuery(varPerformanceRecommendationPagedQuery)
