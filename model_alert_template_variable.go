...
func (o *AlertTemplateVariable) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertTemplateVariable := _AlertTemplateVariable{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAlertTemplateVariable)

	if err != nil {
		return err
	}

	*o = AlertTemplateVariable(varAlertTemplateVariable)
