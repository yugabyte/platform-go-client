...
// checks if the FailedSubtasks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FailedSubtasks{}
...
func (o *FailedSubtasks) GetFailedSubTasks() []SubtaskData {
	if o == nil || IsNil(o.FailedSubTasks) {
		var ret []SubtaskData
		return ret
	}
...
func (o FailedSubtasks) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.FailedSubTasks) {
