...
// checks if the NodeAgentPagedApiQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeAgentPagedApiQuery{}
...
type _NodeAgentPagedApiQuery NodeAgentPagedApiQuery
...
func (o NodeAgentPagedApiQuery) ToMap() (map[string]interface{}, error) {
...
func (o *NodeAgentPagedApiQuery) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeAgentPagedApiQuery := _NodeAgentPagedApiQuery{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeAgentPagedApiQuery)

	if err != nil {
		return err
	}

	*o = NodeAgentPagedApiQuery(varNodeAgentPagedApiQuery)
