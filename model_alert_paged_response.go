...
func (o *AlertPagedResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertPagedResponse := _AlertPagedResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAlertPagedResponse)

	if err != nil {
		return err
	}

	*o = AlertPagedResponse(varAlertPagedResponse)
