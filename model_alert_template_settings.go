...
// checks if the AlertTemplateSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertTemplateSettings{}
...
type _AlertTemplateSettings AlertTemplateSettings
...
func (o AlertTemplateSettings) ToMap() (map[string]interface{}, error) {
...
func (o *AlertTemplateSettings) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertTemplateSettings := _AlertTemplateSettings{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAlertTemplateSettings)

	if err != nil {
		return err
	}

	*o = AlertTemplateSettings(varAlertTemplateSettings)
