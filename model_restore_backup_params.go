...
func (o *RestoreBackupParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRestoreBackupParams := _RestoreBackupParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRestoreBackupParams)

	if err != nil {
		return err
	}

	*o = RestoreBackupParams(varRestoreBackupParams)
