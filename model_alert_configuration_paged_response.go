...
func (o *AlertConfigurationPagedResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertConfigurationPagedResponse := _AlertConfigurationPagedResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAlertConfigurationPagedResponse)

	if err != nil {
		return err
	}

	*o = AlertConfigurationPagedResponse(varAlertConfigurationPagedResponse)
