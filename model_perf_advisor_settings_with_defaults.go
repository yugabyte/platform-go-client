...
// checks if the PerfAdvisorSettingsWithDefaults type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PerfAdvisorSettingsWithDefaults{}
...
func (o PerfAdvisorSettingsWithDefaults) ToMap() (map[string]interface{}, error) {
