...
func (o *RestoreApiFilter) UnmarshalJSON(data []byte) (err error) {
	// This validates that all required properties are included in the JSON object
	// by unmarshalling the object into a generic map with string keys and checking
	// that every required field exists as a key in the generic map.
	requiredProperties := []string{
		"onlyShowDeletedSourceUniverses",
		"restoreUUIDList",
		"showHidden",
	...
	varRestoreApiFilter := _RestoreApiFilter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRestoreApiFilter)

	if err != nil {
		return err
	}

	*o = RestoreApiFilter(varRestoreApiFilter)
