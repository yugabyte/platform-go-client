...
var _ MappedNullable = &RegionFormData{}
...
func (o RegionFormData) ToMap() (map[string]interface{}, error) {
...
func (o *RegionFormData) UnmarshalJSON(data []byte) (err error) {
	...
	varRegionFormData := _RegionFormData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRegionFormData)

	if err != nil {
		return err
	}

	*o = RegionFormData(varRegionFormData)
