...
// checks if the SchedulePagedApiQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SchedulePagedApiQuery{}
...
type _SchedulePagedApiQuery SchedulePagedApiQuery
...
func (o SchedulePagedApiQuery) ToMap() (map[string]interface{}, error) {
...
func (o *SchedulePagedApiQuery) UnmarshalJSON(data []byte) (err error) {
	...
	varSchedulePagedApiQuery := _SchedulePagedApiQuery{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSchedulePagedApiQuery)

	if err != nil {
		return err
	}

	*o = SchedulePagedApiQuery(varSchedulePagedApiQuery)
