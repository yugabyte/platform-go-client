...
type ApiSetLoggingSettingsRequest struct {
	ctx _context.Context
	ApiService *LoggingConfigApiService
	loggingConfig *PlatformLoggingConfig
}

func (r ApiSetLoggingSettingsRequest) LoggingConfig(loggingConfig PlatformLoggingConfig) ApiSetLoggingSettingsRequest {
	r.loggingConfig = &loggingConfig
	return r
}

func (r ApiSetLoggingSettingsRequest) Execute() (PlatformLoggingConfig, *_nethttp.Response, error) {
 ...
 * @return ApiSetLoggingSettingsRequest
 */
func (a *LoggingConfigApiService) SetLoggingSettings(ctx _context.Context) ApiSetLoggingSettingsRequest {
	return ApiSetLoggingSettingsRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *LoggingConfigApiService) SetLoggingSettingsExecute(r ApiSetLoggingSettingsRequest) (PlatformLoggingConfig, *_nethttp.Response, error) {
	var (
