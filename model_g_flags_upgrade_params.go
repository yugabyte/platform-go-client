...
func (o *GFlagsUpgradeParams) UnmarshalJSON(data []byte) (err error) {
	...
	varGFlagsUpgradeParams := _GFlagsUpgradeParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGFlagsUpgradeParams)

	if err != nil {
		return err
	}

	*o = GFlagsUpgradeParams(varGFlagsUpgradeParams)
