...
type SessionManagementApiApiApiLoginRequest struct {
...
func (r SessionManagementApiApiApiLoginRequest) Execute() (SessionInfo, *_nethttp.Response, error) {
 ...
 */
func (a *SessionManagementApiService) ApiLogin(ctx _context.Context) SessionManagementApiApiApiLoginRequest {
	return SessionManagementApiApiApiLoginRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return SessionInfo
 */
func (a *SessionManagementApiService) ApiLoginExecute(r SessionManagementApiApiApiLoginRequest) (SessionInfo, *_nethttp.Response, error) {
	var (
...
type SessionManagementApiApiGetAdminNotificationsRequest struct {
	ctx _context.Context
	ApiService *SessionManagementApiService
	cUUID string
}
...
func (r SessionManagementApiApiGetAdminNotificationsRequest) Execute() (CurrentAdminNotificationMessages, *_nethttp.Response, error) {
 ...
 */
func (a *SessionManagementApiService) GetAdminNotifications(ctx _context.Context, cUUID string) SessionManagementApiApiGetAdminNotificationsRequest {
	return SessionManagementApiApiGetAdminNotificationsRequest{
		ApiService: a,
		ctx: ctx,
		cUUID: cUUID,
 ...
 */
func (a *SessionManagementApiService) GetAdminNotificationsExecute(r SessionManagementApiApiGetAdminNotificationsRequest) (CurrentAdminNotificationMessages, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
