...
func (o *TelemetryProvider) UnmarshalJSON(data []byte) (err error) {
	...
	varTelemetryProvider := _TelemetryProvider{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTelemetryProvider)

	if err != nil {
		return err
	}

	*o = TelemetryProvider(varTelemetryProvider)
