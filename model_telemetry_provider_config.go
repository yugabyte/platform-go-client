...
// checks if the TelemetryProviderConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TelemetryProviderConfig{}
...
func (o TelemetryProviderConfig) ToMap() (map[string]interface{}, error) {
