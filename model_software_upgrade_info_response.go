...
// checks if the SoftwareUpgradeInfoResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SoftwareUpgradeInfoResponse{}
...
func (o *SoftwareUpgradeInfoResponse) GetFinalizeRequired() bool {
	if o == nil || IsNil(o.FinalizeRequired) {
		var ret bool
		return ret
	}
...
func (o SoftwareUpgradeInfoResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.FinalizeRequired) {
