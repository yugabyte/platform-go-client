...
// checks if the Tablespace type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Tablespace{}
...
func (o Tablespace) ToMap() (map[string]interface{}, error) {
...
func (o *Tablespace) UnmarshalJSON(data []byte) (err error) {
	...
	varTablespace := _Tablespace{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTablespace)

	if err != nil {
		return err
	}

	*o = Tablespace(varTablespace)
