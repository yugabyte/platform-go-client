...
var _ MappedNullable = &TableDefinitionTaskParams{}
...
func (o TableDefinitionTaskParams) ToMap() (map[string]interface{}, error) {
...
func (o *TableDefinitionTaskParams) UnmarshalJSON(data []byte) (err error) {
	...
	varTableDefinitionTaskParams := _TableDefinitionTaskParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTableDefinitionTaskParams)

	if err != nil {
		return err
	}

	*o = TableDefinitionTaskParams(varTableDefinitionTaskParams)
