...
// checks if the AlertConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertConfiguration{}
...
type _AlertConfiguration AlertConfiguration
...
func (o AlertConfiguration) ToMap() (map[string]interface{}, error) {
