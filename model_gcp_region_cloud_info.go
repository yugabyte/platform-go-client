...
// checks if the GCPRegionCloudInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GCPRegionCloudInfo{}
...
func (o *GCPRegionCloudInfo) GetInstanceTemplate() string {
	if o == nil || IsNil(o.InstanceTemplate) {
		var ret string
		return ret
	}
...
func (o GCPRegionCloudInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.InstanceTemplate) {
