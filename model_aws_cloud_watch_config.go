...
func (o *AWSCloudWatchConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varAWSCloudWatchConfig := _AWSCloudWatchConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAWSCloudWatchConfig)

	if err != nil {
		return err
	}

	*o = AWSCloudWatchConfig(varAWSCloudWatchConfig)
