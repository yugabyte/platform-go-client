...
func (o *MetricQueryParams) UnmarshalJSON(data []byte) (err error) {
	...
	varMetricQueryParams := _MetricQueryParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMetricQueryParams)

	if err != nil {
		return err
	}

	*o = MetricQueryParams(varMetricQueryParams)
