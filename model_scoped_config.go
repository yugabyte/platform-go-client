...
// checks if the ScopedConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScopedConfig{}
...
func (o *ScopedConfig) GetConfigEntries() []ConfigEntry {
	if o == nil || IsNil(o.ConfigEntries) {
		var ret []ConfigEntry
		return ret
	}
...
func (o ScopedConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ConfigEntries) {
		toSerialize["configEntries"] = o.ConfigEntries
	}
	if !IsNil(o.MutableScope) {
