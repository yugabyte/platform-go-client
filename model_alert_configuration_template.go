...
var _ MappedNullable = &AlertConfigurationTemplate{}
...
type _AlertConfigurationTemplate AlertConfigurationTemplate
...
func (o *AlertConfigurationTemplate) GetDestinationUUID() string {
	if o == nil || IsNil(o.DestinationUUID) {
		var ret string
		return ret
	}
...
func (o *AlertConfigurationTemplate) GetMaintenanceWindowUuids() []string {
	if o == nil || IsNil(o.MaintenanceWindowUuids) {
		var ret []string
		return ret
	}
...
func (o *AlertConfigurationTemplate) GetThresholdConditionReadOnly() bool {
	if o == nil || IsNil(o.ThresholdConditionReadOnly) {
		var ret bool
		return ret
	}
...
func (o *AlertConfigurationTemplate) GetThresholdInteger() bool {
	if o == nil || IsNil(o.ThresholdInteger) {
		var ret bool
		return ret
	}
...
func (o *AlertConfigurationTemplate) GetThresholdMaxValue() float64 {
	if o == nil || IsNil(o.ThresholdMaxValue) {
		var ret float64
		return ret
	}
...
func (o *AlertConfigurationTemplate) GetThresholdMinValue() float64 {
	if o == nil || IsNil(o.ThresholdMinValue) {
		var ret float64
		return ret
	}
...
func (o *AlertConfigurationTemplate) GetThresholdReadOnly() bool {
	if o == nil || IsNil(o.ThresholdReadOnly) {
		var ret bool
		return ret
	}
...
func (o *AlertConfigurationTemplate) GetThresholdUnitName() string {
	if o == nil || IsNil(o.ThresholdUnitName) {
		var ret string
		return ret
	}
...
func (o AlertConfigurationTemplate) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MaintenanceWindowUuids) {
...
func (o *AlertConfigurationTemplate) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertConfigurationTemplate := _AlertConfigurationTemplate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAlertConfigurationTemplate)

	if err != nil {
		return err
	}

	*o = AlertConfigurationTemplate(varAlertConfigurationTemplate)
