...
var _ MappedNullable = &ConfKeyInfo{}
...
func (o ConfKeyInfo) ToMap() (map[string]interface{}, error) {
...
func (o *ConfKeyInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varConfKeyInfo := _ConfKeyInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConfKeyInfo)

	if err != nil {
		return err
	}

	*o = ConfKeyInfo(varConfKeyInfo)
