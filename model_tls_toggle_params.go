...
// checks if the TlsToggleParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TlsToggleParams{}
...
type _TlsToggleParams TlsToggleParams
...
func (o TlsToggleParams) ToMap() (map[string]interface{}, error) {
...
func (o *TlsToggleParams) UnmarshalJSON(data []byte) (err error) {
	...
	varTlsToggleParams := _TlsToggleParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTlsToggleParams)

	if err != nil {
		return err
	}

	*o = TlsToggleParams(varTlsToggleParams)
