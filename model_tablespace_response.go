...
func (o *TablespaceResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varTablespaceResponse := _TablespaceResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTablespaceResponse)

	if err != nil {
		return err
	}

	*o = TablespaceResponse(varTablespaceResponse)
