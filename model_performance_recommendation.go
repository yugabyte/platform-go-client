...
var _ MappedNullable = &PerformanceRecommendation{}
...
func (o PerformanceRecommendation) ToMap() (map[string]interface{}, error) {
...
func (o *PerformanceRecommendation) UnmarshalJSON(data []byte) (err error) {
	...
	varPerformanceRecommendation := _PerformanceRecommendation{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPerformanceRecommendation)

	if err != nil {
		return err
	}

	*o = PerformanceRecommendation(varPerformanceRecommendation)
