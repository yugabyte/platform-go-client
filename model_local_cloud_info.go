...
func (o *LocalCloudInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varLocalCloudInfo := _LocalCloudInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varLocalCloudInfo)

	if err != nil {
		return err
	}

	*o = LocalCloudInfo(varLocalCloudInfo)
