...
var _ MappedNullable = &AlertChannelFormData{}
...
func (o AlertChannelFormData) ToMap() (map[string]interface{}, error) {
...
func (o *AlertChannelFormData) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertChannelFormData := _AlertChannelFormData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAlertChannelFormData)

	if err != nil {
		return err
	}

	*o = AlertChannelFormData(varAlertChannelFormData)
