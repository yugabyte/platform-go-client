...
// checks if the AlertChannelWebHookParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertChannelWebHookParams{}
...
type _AlertChannelWebHookParams AlertChannelWebHookParams
...
func (o AlertChannelWebHookParams) ToMap() (map[string]interface{}, error) {
