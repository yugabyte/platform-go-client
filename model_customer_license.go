...
func (o *CustomerLicense) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomerLicense := _CustomerLicense{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCustomerLicense)

	if err != nil {
		return err
	}

	*o = CustomerLicense(varCustomerLicense)
