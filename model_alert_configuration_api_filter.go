...
// checks if the AlertConfigurationApiFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertConfigurationApiFilter{}
...
func (o AlertConfigurationApiFilter) ToMap() (map[string]interface{}, error) {
