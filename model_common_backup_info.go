...
func (o *CommonBackupInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varCommonBackupInfo := _CommonBackupInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCommonBackupInfo)

	if err != nil {
		return err
	}

	*o = CommonBackupInfo(varCommonBackupInfo)
