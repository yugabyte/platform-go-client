...
var _ MappedNullable = &UpdateLoadBalancerConfig{}
...
func (o UpdateLoadBalancerConfig) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateLoadBalancerConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateLoadBalancerConfig := _UpdateLoadBalancerConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateLoadBalancerConfig)

	if err != nil {
		return err
	}

	*o = UpdateLoadBalancerConfig(varUpdateLoadBalancerConfig)
