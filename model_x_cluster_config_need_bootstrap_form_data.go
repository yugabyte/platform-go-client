...
func (o *XClusterConfigNeedBootstrapFormData) UnmarshalJSON(data []byte) (err error) {
	...
	varXClusterConfigNeedBootstrapFormData := _XClusterConfigNeedBootstrapFormData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varXClusterConfigNeedBootstrapFormData)

	if err != nil {
		return err
	}

	*o = XClusterConfigNeedBootstrapFormData(varXClusterConfigNeedBootstrapFormData)
