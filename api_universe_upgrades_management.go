...
type UniverseUpgradesManagementApiApiModifyAuditLoggingRequest struct {
	ctx _context.Context
	ApiService *UniverseUpgradesManagementApiService
	cUUID string
	uniUUID string
...
func (r UniverseUpgradesManagementApiApiModifyAuditLoggingRequest) AuditLoggingConfig(auditLoggingConfig AuditLogConfigParams) UniverseUpgradesManagementApiApiModifyAuditLoggingRequest {
	r.auditLoggingConfig = &auditLoggingConfig
	return r
}
func (r UniverseUpgradesManagementApiApiModifyAuditLoggingRequest) Request(request interface{}) UniverseUpgradesManagementApiApiModifyAuditLoggingRequest {
	r.request = &request
	return r
}

func (r UniverseUpgradesManagementApiApiModifyAuditLoggingRequest) Execute() (YBPTask, *_nethttp.Response, error) {
	return r.ApiService.ModifyAuditLoggingExecute(r)
}

/*
 * ModifyAuditLogging Modify Audit Logging Configuration
 * YbaApi Internal. Modifies the audit logging configuration for a universe.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param cUUID
 * @param uniUUID
 * @return UniverseUpgradesManagementApiApiModifyAuditLoggingRequest
 */
func (a *UniverseUpgradesManagementApiService) ModifyAuditLogging(ctx _context.Context, cUUID string, uniUUID string) UniverseUpgradesManagementApiApiModifyAuditLoggingRequest {
	return UniverseUpgradesManagementApiApiModifyAuditLoggingRequest{
		ApiService: a,
		ctx: ctx,
		cUUID: cUUID,
 ...
 * @return YBPTask
 */
func (a *UniverseUpgradesManagementApiService) ModifyAuditLoggingExecute(r UniverseUpgradesManagementApiApiModifyAuditLoggingRequest) (YBPTask, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
