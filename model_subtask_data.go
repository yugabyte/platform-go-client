...
// checks if the SubtaskData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubtaskData{}
...
func (o *SubtaskData) GetSubTaskGroupType() string {
	if o == nil || IsNil(o.SubTaskGroupType) {
		var ret string
		return ret
	}
...
func (o SubtaskData) ToMap() (map[string]interface{}, error) {
