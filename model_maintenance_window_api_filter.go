...
var _ MappedNullable = &MaintenanceWindowApiFilter{}
...
func (o MaintenanceWindowApiFilter) ToMap() (map[string]interface{}, error) {
...
func (o *MaintenanceWindowApiFilter) UnmarshalJSON(data []byte) (err error) {
	...
	varMaintenanceWindowApiFilter := _MaintenanceWindowApiFilter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMaintenanceWindowApiFilter)

	if err != nil {
		return err
	}

	*o = MaintenanceWindowApiFilter(varMaintenanceWindowApiFilter)
