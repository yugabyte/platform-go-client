...
func (o *RestoreSnapshotScheduleParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRestoreSnapshotScheduleParams := _RestoreSnapshotScheduleParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRestoreSnapshotScheduleParams)

	if err != nil {
		return err
	}

	*o = RestoreSnapshotScheduleParams(varRestoreSnapshotScheduleParams)
