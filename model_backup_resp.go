...
var _ MappedNullable = &BackupResp{}
...
func (o *BackupResp) GetLastIncrementalBackupTime() time.Time {
	if o == nil || IsNil(o.LastIncrementalBackupTime) {
		var ret time.Time
		return ret
	}
...
func (o BackupResp) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LastIncrementalBackupTime) {
