...
// checks if the VolumeDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VolumeDetails{}
...
type _VolumeDetails VolumeDetails
...
func (o VolumeDetails) ToMap() (map[string]interface{}, error) {
...
func (o *VolumeDetails) UnmarshalJSON(data []byte) (err error) {
	...
	varVolumeDetails := _VolumeDetails{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVolumeDetails)

	if err != nil {
		return err
	}

	*o = VolumeDetails(varVolumeDetails)
