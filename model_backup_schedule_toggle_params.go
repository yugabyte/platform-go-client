...
func (o *BackupScheduleToggleParams) UnmarshalJSON(data []byte) (err error) {
	...
	varBackupScheduleToggleParams := _BackupScheduleToggleParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBackupScheduleToggleParams)

	if err != nil {
		return err
	}

	*o = BackupScheduleToggleParams(varBackupScheduleToggleParams)
