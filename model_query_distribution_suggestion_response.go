...
var _ MappedNullable = &QueryDistributionSuggestionResponse{}
...
func (o QueryDistributionSuggestionResponse) ToMap() (map[string]interface{}, error) {
...
func (o *QueryDistributionSuggestionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varQueryDistributionSuggestionResponse := _QueryDistributionSuggestionResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQueryDistributionSuggestionResponse)

	if err != nil {
		return err
	}

	*o = QueryDistributionSuggestionResponse(varQueryDistributionSuggestionResponse)
