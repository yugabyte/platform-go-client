...
// checks if the HttpLocation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HttpLocation{}
...
func (o HttpLocation) ToMap() (map[string]interface{}, error) {
