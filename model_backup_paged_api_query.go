...
// checks if the BackupPagedApiQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BackupPagedApiQuery{}
...
type _BackupPagedApiQuery BackupPagedApiQuery
...
func (o BackupPagedApiQuery) ToMap() (map[string]interface{}, error) {
...
func (o *BackupPagedApiQuery) UnmarshalJSON(data []byte) (err error) {
	...
	varBackupPagedApiQuery := _BackupPagedApiQuery{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBackupPagedApiQuery)

	if err != nil {
		return err
	}

	*o = BackupPagedApiQuery(varBackupPagedApiQuery)
