...
// checks if the HashedTimestampColumnFinderResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HashedTimestampColumnFinderResponse{}
...
func (o HashedTimestampColumnFinderResponse) ToMap() (map[string]interface{}, error) {
