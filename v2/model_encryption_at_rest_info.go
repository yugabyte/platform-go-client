...
// checks if the EncryptionAtRestInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EncryptionAtRestInfo{}
...
func (o *EncryptionAtRestInfo) GetEncryptionAtRestStatus() bool {
	if o == nil || IsNil(o.EncryptionAtRestStatus) {
		var ret bool
		return ret
	}
...
func (o EncryptionAtRestInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.EncryptionAtRestStatus) {
