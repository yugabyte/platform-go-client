...
type ClusterSpec struct {
	...
	// Instance type for tserver nodes of cluster
	InstanceType string `json:"instance_type"`
	StorageSpec ClusterStorageSpec `json:"storage_spec"`
...
// GetStorageSpec returns the StorageSpec field value
...
// GetStorageSpecOk returns a tuple with the StorageSpec field value
// and a boolean to check if the value has been set.
...
// SetStorageSpec sets field value
