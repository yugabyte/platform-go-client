...
// checks if the YCQLSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &YCQLSpec{}
...
func (o YCQLSpec) ToMap() (map[string]interface{}, error) {
