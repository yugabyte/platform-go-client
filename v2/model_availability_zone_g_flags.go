...
// checks if the AvailabilityZoneGFlags type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailabilityZoneGFlags{}
...
func (o AvailabilityZoneGFlags) ToMap() (map[string]interface{}, error) {
