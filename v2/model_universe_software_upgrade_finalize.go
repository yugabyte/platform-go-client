...
// checks if the UniverseSoftwareUpgradeFinalize type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UniverseSoftwareUpgradeFinalize{}
...
func (o UniverseSoftwareUpgradeFinalize) ToMap() (map[string]interface{}, error) {
