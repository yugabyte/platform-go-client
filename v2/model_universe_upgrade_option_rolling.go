...
// checks if the UniverseUpgradeOptionRolling type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UniverseUpgradeOptionRolling{}
...
func (o UniverseUpgradeOptionRolling) ToMap() (map[string]interface{}, error) {
