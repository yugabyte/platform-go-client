...
// checks if the JobScheduleUpdateSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JobScheduleUpdateSpec{}
...
type _JobScheduleUpdateSpec JobScheduleUpdateSpec
...
func (o JobScheduleUpdateSpec) ToMap() (map[string]interface{}, error) {
...
func (o *JobScheduleUpdateSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varJobScheduleUpdateSpec := _JobScheduleUpdateSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varJobScheduleUpdateSpec)

	if err != nil {
		return err
	}

	*o = JobScheduleUpdateSpec(varJobScheduleUpdateSpec)
