...
func (o *IsolatedBackupRestoreSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varIsolatedBackupRestoreSpec := _IsolatedBackupRestoreSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIsolatedBackupRestoreSpec)

	if err != nil {
		return err
	}

	*o = IsolatedBackupRestoreSpec(varIsolatedBackupRestoreSpec)
