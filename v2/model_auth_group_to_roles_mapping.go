...
func (o *AuthGroupToRolesMapping) UnmarshalJSON(data []byte) (err error) {
	...
	varAuthGroupToRolesMapping := _AuthGroupToRolesMapping{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAuthGroupToRolesMapping)

	if err != nil {
		return err
	}

	*o = AuthGroupToRolesMapping(varAuthGroupToRolesMapping)
