...
func (o *UniverseSoftwareUpgradeStart) UnmarshalJSON(data []byte) (err error) {
	...
	varUniverseSoftwareUpgradeStart := _UniverseSoftwareUpgradeStart{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUniverseSoftwareUpgradeStart)

	if err != nil {
		return err
	}

	*o = UniverseSoftwareUpgradeStart(varUniverseSoftwareUpgradeStart)
