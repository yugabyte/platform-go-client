...
// checks if the UniverseUpgradeOptionsAll type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UniverseUpgradeOptionsAll{}
...
func (o UniverseUpgradeOptionsAll) ToMap() (map[string]interface{}, error) {
