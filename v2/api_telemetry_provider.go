...
/*
ListTelemetryProviderTypes List Available Telemetry Provider Types
...
func (a *TelemetryProviderAPIService) ListTelemetryProviderTypesExecute(r TelemetryProviderAPIListTelemetryProviderTypesRequest) ([]TelemetryProviderTypeInfo, *http.Response, error) {
	...
	localVarPath := localBasePath + "/customers/{cUUID}/telemetry-provider/types"
	...
	if r.exportType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "exportType", r.exportType, "form", "")
	}
