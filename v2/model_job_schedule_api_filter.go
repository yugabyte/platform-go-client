...
// checks if the JobScheduleApiFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JobScheduleApiFilter{}
...
func (o *JobScheduleApiFilter) GetNextStartWindowSecs() int64 {
	if o == nil || IsNil(o.NextStartWindowSecs) {
		var ret int64
		return ret
	}
