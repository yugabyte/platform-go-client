...
// checks if the UniverseEditKubernetesOverrides type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UniverseEditKubernetesOverrides{}
...
func (o UniverseEditKubernetesOverrides) ToMap() (map[string]interface{}, error) {
