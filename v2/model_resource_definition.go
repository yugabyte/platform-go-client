...
// checks if the ResourceDefinition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceDefinition{}
...
type _ResourceDefinition ResourceDefinition
...
func (o *ResourceDefinition) GetResourceUuidSet() []string {
	if o == nil || IsNil(o.ResourceUuidSet) {
		var ret []string
		return ret
	}
...
func (o ResourceDefinition) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["resource_type"] = o.ResourceType
	toSerialize["allow_all"] = o.AllowAll
	if !IsNil(o.ResourceUuidSet) {
		toSerialize["resource_uuid_set"] = o.ResourceUuidSet
	}
	return toSerialize, nil
}

func (o *ResourceDefinition) UnmarshalJSON(data []byte) (err error) {
	...
	varResourceDefinition := _ResourceDefinition{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResourceDefinition)

	if err != nil {
		return err
	}

	*o = ResourceDefinition(varResourceDefinition)
