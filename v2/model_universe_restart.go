...
// checks if the UniverseRestart type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UniverseRestart{}
...
func (o *UniverseRestart) GetRollingRestart() bool {
	if o == nil || IsNil(o.RollingRestart) {
		var ret bool
		return ret
	}
...
func (o UniverseRestart) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RollingRestart) {
		toSerialize["rolling_restart"] = o.RollingRestart
	}
	if !IsNil(o.RestartType) {
