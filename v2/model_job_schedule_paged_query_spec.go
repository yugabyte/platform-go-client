...
// checks if the JobSchedulePagedQuerySpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JobSchedulePagedQuerySpec{}

// JobSchedulePagedQuerySpec struct for JobSchedulePagedQuerySpec
...
func (o JobSchedulePagedQuerySpec) ToMap() (map[string]interface{}, error) {
