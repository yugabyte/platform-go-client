...
// checks if the ClusterNetworkingSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterNetworkingSpec{}
...
func (o ClusterNetworkingSpec) ToMap() (map[string]interface{}, error) {
