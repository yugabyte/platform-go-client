...
func (o *JobScheduleConfigSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varJobScheduleConfigSpec := _JobScheduleConfigSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varJobScheduleConfigSpec)

	if err != nil {
		return err
	}

	*o = JobScheduleConfigSpec(varJobScheduleConfigSpec)
