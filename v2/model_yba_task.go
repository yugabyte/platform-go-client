...
// checks if the YBATask type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &YBATask{}
...
func (o YBATask) ToMap() (map[string]interface{}, error) {
