...
// checks if the ClusterGFlags type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterGFlags{}
...
func (o ClusterGFlags) ToMap() (map[string]interface{}, error) {
