...
// checks if the JobInstanceApiFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JobInstanceApiFilter{}
...
func (o *JobInstanceApiFilter) GetStartWindowSecs() int64 {
	if o == nil || IsNil(o.StartWindowSecs) {
		var ret int64
		return ret
	}
...
func (o JobInstanceApiFilter) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.StartWindowSecs) {
