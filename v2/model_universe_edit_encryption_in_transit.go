...
// checks if the UniverseEditEncryptionInTransit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UniverseEditEncryptionInTransit{}
...
func (o UniverseEditEncryptionInTransit) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NodeToNode) {
		toSerialize["node_to_node"] = o.NodeToNode
	}
	if !IsNil(o.ClientToNode) {
