...
**InstanceType** | **string** | Instance type for tserver nodes of cluster | 
**StorageSpec** | [**ClusterStorageSpec**](ClusterStorageSpec.md) |  | 
...
`func NewClusterSpec(clusterType string, numNodes int32, instanceType string, storageSpec ClusterStorageSpec, providerSpec ClusterProviderSpec, ) *ClusterSpec`
...
`func (o *ClusterSpec) GetInstanceType() string`

GetInstanceType returns the InstanceType field if non-nil, zero value otherwise.

### GetInstanceTypeOk

`func (o *ClusterSpec) GetInstanceTypeOk() (*string, bool)`
...
`func (o *ClusterSpec) SetInstanceType(v string)`
...
`func (o *ClusterSpec) GetStorageSpec() ClusterStorageSpec`

GetStorageSpec returns the StorageSpec field if non-nil, zero value otherwise.

### GetStorageSpecOk

`func (o *ClusterSpec) GetStorageSpecOk() (*ClusterStorageSpec, bool)`
...
`func (o *ClusterSpec) SetStorageSpec(v ClusterStorageSpec)`
