...
**StorageType** | Pointer to **string** | Storage type used for this instance, if this is a aws (IO1, GP2, GP3), gcp (Scratch, Persistent) or azu (StandardSSD_LRS, Premium_LRS, UltraSSD_LRS) cluster. | [optional] 
...
`func NewClusterStorageSpec() *ClusterStorageSpec`
...
`func (o *ClusterStorageSpec) HasVolumeSize() bool`
...
`func (o *ClusterStorageSpec) HasNumVolumes() bool`
