...
**InstanceType** | **string** | Set instance type for tserver nodes of cluster | 
...
`func NewClusterAddSpec(clusterType string, numNodes int32, instanceType string, providerSpec ClusterProviderEditSpec, ) *ClusterAddSpec`
...
`func (o *ClusterAddSpec) GetInstanceType() string`

GetInstanceType returns the InstanceType field if non-nil, zero value otherwise.

### GetInstanceTypeOk

`func (o *ClusterAddSpec) GetInstanceTypeOk() (*string, bool)`
...
`func (o *ClusterAddSpec) SetInstanceType(v string)`
...
`func (o *ClusterAddSpec) GetStorageSpec() ClusterStorageSpec`

GetStorageSpec returns the StorageSpec field if non-nil, zero value otherwise.

### GetStorageSpecOk

`func (o *ClusterAddSpec) GetStorageSpecOk() (*ClusterStorageSpec, bool)`
...
`func (o *ClusterAddSpec) SetStorageSpec(v ClusterStorageSpec)`

SetStorageSpec sets StorageSpec field to given value.

### HasStorageSpec

`func (o *ClusterAddSpec) HasStorageSpec() bool`
