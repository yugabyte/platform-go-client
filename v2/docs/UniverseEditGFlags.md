...
------------ | ------------- | ------------- | -------------
**UpgradeOption** | Pointer to **string** | Universe upgrade option to use. * \&quot;Rolling\&quot; - Apply GFlags to each node one at a time * \&quot;Non-rolling\&quot; - Apply GFlags to all nodes at the same time, so has client downtime * \&quot;Non-restart\&quot; - Apply GFlags without restarting nodes or processes. Applicable to only certain supported GFlags. | [optional] 
**KubernetesResourceDetails** | Pointer to [**KubernetesResourceDetails**](KubernetesResourceDetails.md) |  | [optional] 
**SleepAfterMasterRestartMillis** | Pointer to **int32** | Applicable for rolling restarts. Time to wait between master restarts. Defaults to 180000. | [optional] 
**SleepAfterTserverRestartMillis** | Pointer to **int32** | Applicable for rolling restarts. Time to wait between tserver restarts. Defaults to 180000. | [optional] 
