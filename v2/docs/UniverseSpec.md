...
**UseSystemd** | Pointer to **bool** | Whether to enable systemd on nodes of cluster. Defaults to false. Can be changed using API /customers/:cUUID/universes/:uniUUID/upgrade/systemd. | [optional] [default to true]
...
`func (o *UniverseSpec) GetUseSystemd() bool`

GetUseSystemd returns the UseSystemd field if non-nil, zero value otherwise.

### GetUseSystemdOk

`func (o *UniverseSpec) GetUseSystemdOk() (*bool, bool)`
...
`func (o *UniverseSpec) SetUseSystemd(v bool)`

SetUseSystemd sets UseSystemd field to given value.

### HasUseSystemd

`func (o *UniverseSpec) HasUseSystemd() bool`
