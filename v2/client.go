...
// APIClient manages communication with the YugabyteDB Anywhere V2 APIs API vv2
...
type APIClient struct {
	...
	BackupAndRestoreAPI *BackupAndRestoreAPIService
	...
	YBAInstanceAPI *YBAInstanceAPIService
}
