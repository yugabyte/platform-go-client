...
// checks if the JobScheduleSnoozeSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JobScheduleSnoozeSpec{}
...
type _JobScheduleSnoozeSpec JobScheduleSnoozeSpec
...
func (o JobScheduleSnoozeSpec) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["snooze_secs"] = o.SnoozeSecs
	return toSerialize, nil
}

func (o *JobScheduleSnoozeSpec) UnmarshalJSON(data []byte) (err error) {
	...
	varJobScheduleSnoozeSpec := _JobScheduleSnoozeSpec{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varJobScheduleSnoozeSpec)

	if err != nil {
		return err
	}

	*o = JobScheduleSnoozeSpec(varJobScheduleSnoozeSpec)
