...
// checks if the NodeProxyConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeProxyConfig{}
...
func (o NodeProxyConfig) ToMap() (map[string]interface{}, error) {
