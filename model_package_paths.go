...
// checks if the PackagePaths type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PackagePaths{}
...
func (o *PackagePaths) GetHelmChartChecksum() string {
	if o == nil || IsNil(o.HelmChartChecksum) {
		var ret string
		return ret
	}
...
func (o *PackagePaths) GetX8664Checksum() string {
	if o == nil || IsNil(o.X8664Checksum) {
		var ret string
		return ret
	}
