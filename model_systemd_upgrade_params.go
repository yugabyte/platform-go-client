...
// checks if the SystemdUpgradeParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemdUpgradeParams{}
...
type _SystemdUpgradeParams SystemdUpgradeParams
...
func (o SystemdUpgradeParams) MarshalJSON() ([]byte, error) {
...
func (o SystemdUpgradeParams) ToMap() (map[string]interface{}, error) {
...
func (o *SystemdUpgradeParams) UnmarshalJSON(data []byte) (err error) {
	...
	varSystemdUpgradeParams := _SystemdUpgradeParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSystemdUpgradeParams)

	if err != nil {
		return err
	}

	*o = SystemdUpgradeParams(varSystemdUpgradeParams)

	return err
}

type NullableSystemdUpgradeParams struct {
	value *SystemdUpgradeParams
	isSet bool
}

func (v NullableSystemdUpgradeParams) Get() *SystemdUpgradeParams {
	return v.value
}

func (v *NullableSystemdUpgradeParams) Set(val *SystemdUpgradeParams) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemdUpgradeParams) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemdUpgradeParams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemdUpgradeParams(val *SystemdUpgradeParams) *NullableSystemdUpgradeParams {
	return &NullableSystemdUpgradeParams{value: val, isSet: true}
}

func (v NullableSystemdUpgradeParams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemdUpgradeParams) UnmarshalJSON(src []byte) error {
	v.isSet = true
