...
// checks if the UniverseConfigureTaskParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UniverseConfigureTaskParams{}
...
type _UniverseConfigureTaskParams UniverseConfigureTaskParams
...
func (o *UniverseConfigureTaskParams) GetAllowGeoPartitioning() bool {
	if o == nil || IsNil(o.AllowGeoPartitioning) {
		var ret bool
		return ret
	}
...
func (o *UniverseConfigureTaskParams) GetClusterOperation() string {
	if o == nil || IsNil(o.ClusterOperation) {
		var ret string
		return ret
	}
...
func (o *UniverseConfigureTaskParams) GetRegionsChanged() bool {
	if o == nil || IsNil(o.RegionsChanged) {
		var ret bool
		return ret
	}
...
func (o *UniverseConfigureTaskParams) UnmarshalJSON(data []byte) (err error) {
	...
	varUniverseConfigureTaskParams := _UniverseConfigureTaskParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUniverseConfigureTaskParams)

	if err != nil {
		return err
	}

	*o = UniverseConfigureTaskParams(varUniverseConfigureTaskParams)
