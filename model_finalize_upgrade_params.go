...
func (o *FinalizeUpgradeParams) UnmarshalJSON(data []byte) (err error) {
	...
	varFinalizeUpgradeParams := _FinalizeUpgradeParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFinalizeUpgradeParams)

	if err != nil {
		return err
	}

	*o = FinalizeUpgradeParams(varFinalizeUpgradeParams)
