...
func (o *AlertTemplateSettingsFormData) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertTemplateSettingsFormData := _AlertTemplateSettingsFormData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAlertTemplateSettingsFormData)

	if err != nil {
		return err
	}

	*o = AlertTemplateSettingsFormData(varAlertTemplateSettingsFormData)
