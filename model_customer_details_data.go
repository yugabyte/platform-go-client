...
func (o *CustomerDetailsData) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomerDetailsData := _CustomerDetailsData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCustomerDetailsData)

	if err != nil {
		return err
	}

	*o = CustomerDetailsData(varCustomerDetailsData)
