...
func (o *NodeAgentApiFilter) UnmarshalJSON(data []byte) (err error) {
	...
	varNodeAgentApiFilter := _NodeAgentApiFilter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNodeAgentApiFilter)

	if err != nil {
		return err
	}

	*o = NodeAgentApiFilter(varNodeAgentApiFilter)
