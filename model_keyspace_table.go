...
// checks if the KeyspaceTable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KeyspaceTable{}
...
func (o KeyspaceTable) ToMap() (map[string]interface{}, error) {
