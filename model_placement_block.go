...
func (o *PlacementBlock) UnmarshalJSON(data []byte) (err error) {
	...
	varPlacementBlock := _PlacementBlock{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPlacementBlock)

	if err != nil {
		return err
	}

	*o = PlacementBlock(varPlacementBlock)
