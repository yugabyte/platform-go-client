...
func (o *ClientCertParams) UnmarshalJSON(data []byte) (err error) {
	...
	varClientCertParams := _ClientCertParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varClientCertParams)

	if err != nil {
		return err
	}

	*o = ClientCertParams(varClientCertParams)
