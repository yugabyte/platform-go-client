...
func (o *ReplicaPlacement) UnmarshalJSON(data []byte) (err error) {
	...
	varReplicaPlacement := _ReplicaPlacement{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReplicaPlacement)

	if err != nil {
		return err
	}

	*o = ReplicaPlacement(varReplicaPlacement)
