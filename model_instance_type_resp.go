...
func (o *InstanceTypeResp) UnmarshalJSON(data []byte) (err error) {
	...
	varInstanceTypeResp := _InstanceTypeResp{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInstanceTypeResp)

	if err != nil {
		return err
	}

	*o = InstanceTypeResp(varInstanceTypeResp)
