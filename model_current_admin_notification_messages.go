...
// checks if the CurrentAdminNotificationMessages type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CurrentAdminNotificationMessages{}
...
func (o CurrentAdminNotificationMessages) ToMap() (map[string]interface{}, error) {
