...
var _ MappedNullable = &AuditLoggingConfig{}
...
type _AuditLoggingConfig AuditLoggingConfig
...
func (o *AuditLoggingConfig) GetRolloverPattern() string {
	if o == nil || IsNil(o.RolloverPattern) {
		var ret string
		return ret
	}
...
func (o AuditLoggingConfig) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RolloverPattern) {
		toSerialize["rolloverPattern"] = o.RolloverPattern
	}
	return toSerialize, nil
}

func (o *AuditLoggingConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varAuditLoggingConfig := _AuditLoggingConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAuditLoggingConfig)

	if err != nil {
		return err
	}

	*o = AuditLoggingConfig(varAuditLoggingConfig)
