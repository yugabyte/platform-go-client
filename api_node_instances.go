...
type NodeInstancesAPIListRequest struct {
	ctx        context.Context
	ApiService *NodeInstancesAPIService
	cUUID      string
	nodeIp     *string
...
func (r NodeInstancesAPIListRequest) NodeIp(nodeIp string) NodeInstancesAPIListRequest {
	r.nodeIp = &nodeIp
	return r
}

func (r NodeInstancesAPIListRequest) Execute() (*NodeInstance, *http.Response, error) {
	return r.ApiService.ListExecute(r)
}

/*
List List all node instances of a customer

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param cUUID
	@return NodeInstancesAPIListRequest
*/
func (a *NodeInstancesAPIService) List(ctx context.Context, cUUID string) NodeInstancesAPIListRequest {
	return NodeInstancesAPIListRequest{
		ApiService: a,
		ctx:        ctx,
		cUUID:      cUUID,
...
//
//	@return NodeInstance
func (a *NodeInstancesAPIService) ListExecute(r NodeInstancesAPIListRequest) (*NodeInstance, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NodeInstancesAPIService.List")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/customers/{cUUID}/nodes"
	localVarPath = strings.Replace(localVarPath, "{"+"cUUID"+"}", url.PathEscape(parameterValueToString(r.cUUID, "cUUID")), -1)
