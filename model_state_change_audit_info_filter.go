...
func (o *StateChangeAuditInfoFilter) UnmarshalJSON(data []byte) (err error) {
	...
	varStateChangeAuditInfoFilter := _StateChangeAuditInfoFilter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varStateChangeAuditInfoFilter)

	if err != nil {
		return err
	}

	*o = StateChangeAuditInfoFilter(varStateChangeAuditInfoFilter)
