...
func (o *RestartBootstrapParams) UnmarshalJSON(data []byte) (err error) {
	...
	varRestartBootstrapParams := _RestartBootstrapParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRestartBootstrapParams)

	if err != nil {
		return err
	}

	*o = RestartBootstrapParams(varRestartBootstrapParams)
