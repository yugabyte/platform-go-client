...
func (o *HashicorpVaultConfigParams) UnmarshalJSON(data []byte) (err error) {
	...
	varHashicorpVaultConfigParams := _HashicorpVaultConfigParams{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHashicorpVaultConfigParams)

	if err != nil {
		return err
	}

	*o = HashicorpVaultConfigParams(varHashicorpVaultConfigParams)
