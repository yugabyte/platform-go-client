...
func (o *ReleaseFormData) UnmarshalJSON(data []byte) (err error) {
	...
	varReleaseFormData := _ReleaseFormData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReleaseFormData)

	if err != nil {
		return err
	}

	*o = ReleaseFormData(varReleaseFormData)
