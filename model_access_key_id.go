...
// checks if the AccessKeyId type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessKeyId{}
...
func (o AccessKeyId) ToMap() (map[string]interface{}, error) {
