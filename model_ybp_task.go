...
// checks if the YBPTask type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &YBPTask{}
...
func (o YBPTask) ToMap() (map[string]interface{}, error) {
