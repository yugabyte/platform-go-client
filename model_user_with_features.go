...
func (o *UserWithFeatures) UnmarshalJSON(data []byte) (err error) {
	...
	varUserWithFeatures := _UserWithFeatures{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUserWithFeatures)

	if err != nil {
		return err
	}

	*o = UserWithFeatures(varUserWithFeatures)
