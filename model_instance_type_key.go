...
func (o *InstanceTypeKey) UnmarshalJSON(data []byte) (err error) {
	...
	varInstanceTypeKey := _InstanceTypeKey{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInstanceTypeKey)

	if err != nil {
		return err
	}

	*o = InstanceTypeKey(varInstanceTypeKey)
